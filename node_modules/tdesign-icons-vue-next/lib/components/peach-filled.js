...
var peachFilled = vue.defineComponent({
  name: "PeachFilledIcon",
  props: {
    size: {
      type: String
    },
  ...
  setup(props, _ref) {
    ...
    var finalCls = vue.computed(() => ["t-icon", "t-icon-peach-filled", className.value]);
...
exports.default = peachFilled;
//# sourceMappingURL=peach-filled.js.map
