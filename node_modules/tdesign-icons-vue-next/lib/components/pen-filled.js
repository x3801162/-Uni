...
var penFilled = vue.defineComponent({
  name: "PenFilledIcon",
  props: {
    size: {
      type: String
  ...
  setup(props, _ref) {
    ...
    var finalCls = vue.computed(() => ["t-icon", "t-icon-pen-filled", className.value]);
...
exports.default = penFilled;
//# sourceMappingURL=pen-filled.js.map
