...
var undertakeDeliveryFilled = vue.defineComponent({
  ...
  setup(props, _ref) {
    ...
    var finalCls = vue.computed(() => ["t-icon", "t-icon-undertake-delivery-filled", className.value]);
...
exports.default = undertakeDeliveryFilled;
