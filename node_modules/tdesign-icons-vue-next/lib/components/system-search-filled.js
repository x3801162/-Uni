...
var systemSearchFilled = vue.defineComponent({
  ...
  setup(props, _ref) {
    ...
    var finalCls = vue.computed(() => ["t-icon", "t-icon-system-search-filled", className.value]);
...
exports.default = systemSearchFilled;
