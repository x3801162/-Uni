...
var visualRecognitionFilled = vue.defineComponent({
  ...
  setup(props, _ref) {
    ...
    var finalCls = vue.computed(() => ["t-icon", "t-icon-visual-recognition-filled", className.value]);
...
exports.default = visualRecognitionFilled;
