...
var noResultFilled = vue.defineComponent({
  name: "NoResultFilledIcon",
  props: {
    size: {
      type: String
    },
  ...
  setup(props, _ref) {
    ...
    var finalCls = vue.computed(() => ["t-icon", "t-icon-no-result-filled", className.value]);
...
exports.default = noResultFilled;
