...
var gestureRightSlipFilled = vue.defineComponent({
  name: "GestureRightSlipFilledIcon",
  props: {
    size: {
      type: String
    },
  ...
  setup(props, _ref) {
    ...
    var finalCls = vue.computed(() => ["t-icon", "t-icon-gesture-right-slip-filled", className.value]);
...
exports.default = gestureRightSlipFilled;
//# sourceMappingURL=gesture-right-slip-filled.js.map
