...
var uncomfortableFilled = vue.defineComponent({
  ...
  setup(props, _ref) {
    ...
    var finalCls = vue.computed(() => ["t-icon", "t-icon-uncomfortable-filled", className.value]);
...
exports.default = uncomfortableFilled;
