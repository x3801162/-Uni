...
:root {
  ...
  --td-font-mark-extraSmall: var(--td-font-size-mark-extraSmall) / var(--td-line-height-mark-extraSmall) var(--td-font-family);
  --td-font-mark-small: var(--td-font-size-mark-small) / var(--td-line-height-mark-small) var(--td-font-family);
  --td-font-mark-medium: var(--td-font-size-mark-medium) / var(--td-line-height-mark-medium) var(--td-font-family);
  --td-font-mark-large: var(--td-font-size-mark-large) / var(--td-line-height-mark-large) var(--td-font-family);
  ...
  --td-font-title-extraLarge: var(--td-font-size-title-extraLarge) / var(--td-line-height-title-extraLarge) var(--td-font-family);
...
.t-fab__button {
  -webkit-box-shadow: var(--td-fab-shadow, var(--td-shadow-2, 0 3px 14px 2px rgba(0, 0, 0, 0.05), 0 8px 10px 1px rgba(0, 0, 0, 0.06), 0 5px 5px -3px rgba(0, 0, 0, 0.1)));
...
.t-drawer__sidebar-item-icon {
  padding-right: 8px;
  color: var(--td-drawer-title-color, var(--td-drawer-title-color, var(--td-text-color-primary, var(--td-font-gray-1, rgba(0, 0, 0, 0.9)))));
...
.t-badge--ribbon::before {
  left: calc(-1 * var(--td-badge-basic-height, 16px) + 0.5px);
  border-left: var(--td-badge-basic-height, 16px) solid transparent;
}
.t-badge--ribbon::after {
  right: calc(-1 * var(--td-badge-basic-height, 16px) + 0.5px);
...
.t-tab-bar--round {
  ...
  margin-right: 16px;
  border-radius: 999px;
  -webkit-box-shadow: var(--td-tab-bar-round-shadow, var(--td-shadow-3, 0 6px 30px 5px rgba(0, 0, 0, 0.05), 0 16px 24px 2px rgba(0, 0, 0, 0.04), 0 8px 10px -5px rgba(0, 0, 0, 0.08)));
...
.t-tab-bar-item__spread {
  ...
  border-radius: 6px;
  color: var(--td-tab-bar-color, var(--td-text-color-primary, var(--td-font-gray-1, rgba(0, 0, 0, 0.9))));
  -webkit-box-shadow: var(--td-tab-bar-spread-shadow, var(--td-shadow-3, 0 6px 30px 5px rgba(0, 0, 0, 0.05), 0 16px 24px 2px rgba(0, 0, 0, 0.04), 0 8px 10px -5px rgba(0, 0, 0, 0.08)));
...
.t-calendar__dates-item {
  ...
  font-weight: 600;
  margin-top: 8px;
  color: var(--td-calendar-dates-color, var(--td-text-color-primary, var(--td-font-gray-1, rgba(0, 0, 0, 0.9))));
  cursor: pointer;
  -webkit-tap-highlight-color: transparent;
  /* stylelint-disable-next-line */
  -webkit-user-select: none;
...
.t-cascader__title {
  ...
  line-height: 48px;
  height: 48px;
  font-size: var(--td-cascader-title-font-size, 18px);
}
.t-cascader__content {
  width: 100%;
  -webkit-box-flex: 1;
...
.t-color-picker__thumb {
  ...
  -webkit-box-shadow: var(--td-shadow-1, 0 1px 10px rgba(0, 0, 0, 0.05), 0 4px 5px rgba(0, 0, 0, 0.08), 0 2px 4px -1px rgba(0, 0, 0, 0.12));
...
.t-color-picker__swatches-item {
  ...
  -webkit-transition: all var(--td-anim-duration-base, 0.2s) var(--td-anim-time-fn-easing, cubic-bezier(0.38, 0, 0.24, 1));
...
.t-picker-item__item--disabled {
  color: var(--td-picker-item-disabled-color, var(--td-text-color-disabled, var(--td-font-gray-4, rgba(0, 0, 0, 0.26))));
}
...
.t-switch__dot {
  ...
  -webkit-transform: translateY(-50%);
          transform: translateY(-50%);
  -webkit-box-shadow: var(--td-switch-dot-shadow, var(--td-shadow-1, 0 1px 10px rgba(0, 0, 0, 0.05), 0 4px 5px rgba(0, 0, 0, 0.08), 0 2px 4px -1px rgba(0, 0, 0, 0.12)));
...
.t-textarea__placeholder:-ms-input-placeholder {
  color: var(--td-textarea-placeholder-color, var(--td-text-color-placeholder, var(--td-font-gray-3, rgba(0, 0, 0, 0.4))));
  font-size: var(--td-font-size-m, 16px);
}
.t-textarea__placeholder::-ms-input-placeholder {
...
.t-collapse-panel--disabled .t-cell__title-text {
  color: var(--td-collapse-header-text-disabled-color, var(--td-text-color-disabled, var(--td-font-gray-4, rgba(0, 0, 0, 0.26))));
}
.t-collapse-panel__body {
  display: grid;
  -webkit-transition: grid-template-rows ease 240ms;
  transition: grid-template-rows ease 240ms;
  transition: grid-template-rows ease 240ms, -ms-grid-rows ease 240ms;
}
...
.t-footer__title {
  ...
  font-style: italic;
  color: var(--td-footer-title-color, var(--td-text-color-primary, var(--td-font-gray-1, rgba(0, 0, 0, 0.9))));
}
.t-footer__title-url {
...
.t-grid-item__title--middle {
  font: var(--td-grid-item-text-font, var(--td-font-body-small));
}
...
.t-action-sheet__list-item--disabled {
  ...
  --td-button-default-disabled-color: var(--td-action-sheet-list-item-disabled-color, var(--td-text-color-disabled, var(--td-font-gray-4, rgba(0, 0, 0, 0.26))));
}
...
.t-action-sheet__dots {
  --td-swiper-nav-dot-color: var(--td-action-sheet-dot-color, var(--td-text-color-disabled, var(--td-font-gray-4, rgba(0, 0, 0, 0.26))));
...
.t-dropdown-menu__item {
  ...
  position: relative;
  overflow: hidden;
  color: var(--td-dropdown-menu-colorm, var(--td-text-color-primary, var(--td-font-gray-1, rgba(0, 0, 0, 0.9))));
}
...
.t-dropdown-menu__item--disabled {
  color: var(--td-dropdown-menu-disabled-colorm, var(--td-text-color-disabled, var(--td-font-gray-4, rgba(0, 0, 0, 0.26))));
}
...
.t-guide__highlight--mask {
  -webkit-box-shadow: 0 0 0 0 var(--td-mask-active, rgba(0, 0, 0, 0.6)), var(--td-mask-active, rgba(0, 0, 0, 0.6)) 0 0 0 5000px;
          box-shadow: 0 0 0 0 var(--td-mask-active, rgba(0, 0, 0, 0.6)), var(--td-mask-active, rgba(0, 0, 0, 0.6)) 0 0 0 5000px;
}
...
.t-message {
  ...
  -webkit-box-shadow: var(--td-message-box-shadow, var(--td-shadow-4, 0 2px 8px 0 rgba(0, 0, 0, 0.06)));
...
.message-enter-active {
  -webkit-animation: messageEnter 0.5s;
          animation: messageEnter 0.5s;
}
.message-leave-active {
  -webkit-animation: messageOut 0.2s;
...
.t-pull-down-refresh__track--loosing {
  -webkit-transition: -webkit-transform ease 0.24s;
  transition: -webkit-transform ease 0.24s;
  transition: transform ease 0.24s;
  transition: transform ease 0.24s, -webkit-transform ease 0.24s;
}
