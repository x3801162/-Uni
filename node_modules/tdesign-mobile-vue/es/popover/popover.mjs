...
import { isVNode, defineComponent, toRefs, ref, computed, onUnmounted, watch, createVNode, Fragment, Transition } from 'vue';
import PopoverProps from './props.mjs';
import config from '../config.mjs';
import { useTNodeJSX, useContent } from '../hooks/tnode.mjs';
import '../shared/index.mjs';
import useVModel from '../hooks/useVModel.mjs';
import { usePrefixClass } from '../hooks/useClass.mjs';
import { useClickAway } from '../shared/useClickAway/index.mjs';
...
var _Popover = defineComponent({
  ...
  setup: function setup(props, context) {
    ...
    var contentClasses = computed(function () {
      return ["".concat(popoverClass.value, "__content"), "".concat(popoverClass.value, "--").concat(props.theme), props.showArrow ? "".concat(popoverClass.value, "__content--arrow") : ""];
    });
    var popper;
    ...
    var placementPadding = function placementPadding(_ref) {
      ...
      if (isHorizontal) {
        ...
        return _defineProperty({}, isEnd ? "left" : "right", padding - 28);
      }
      var isVertical = vertical.find(function (item) {
        return placement.includes(item);
      });
      if (isVertical) {
        return _defineProperty({}, isEnd ? "top" : "bottom", popperHeight - 28);
      }
    };
    ...
    var closeOnClickOutside = ref(useClickAway([referenceRef, popoverRef], function () {
      onClickAway();
    }, {
      detectIframe: true
    }));
    ...
    var renderArrow = function renderArrow() {
      return props.showArrow && createVNode("div", {
