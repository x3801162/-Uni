...
import { a as _arrayWithHoles, b as _nonIterableRest, _ as _slicedToArray } from '../../../_chunks/dep-2ed7e0d5.mjs';
import { a as _iterableToArray } from '../../../_chunks/dep-fb069758.mjs';
import { _ as _unsupportedIterableToArray } from '../../../_chunks/dep-9961b95b.mjs';
...
function validateFile(params) {
  var files = params.files,
    ...
    _params$capture = params.capture,
    capture = _params$capture === void 0 ? "" : _params$capture;
  return new Promise(function (resolve) {
    ...
    Promise.all([allFileValidatePromise].concat(promiseList)).then(function (results) {
      var _results = _toArray(results),
        ...
        others = _arrayLikeToArray(_results).slice(1);
