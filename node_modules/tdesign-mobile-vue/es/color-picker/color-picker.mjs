...
import { getFormatList, genSwatchList, getCoordinate } from './helper.mjs';
import '../_common/js/color-picker/index.mjs';
import { DEFAULT_COLOR } from '../_common/js/color-picker/constants.mjs';
import { HUE_MAX, ALPHA_MAX } from './constants.mjs';
