...
import { isVNode, defineComponent, reactive, toRefs, computed, ref, h, nextTick, watch, onUnmounted, createVNode, Transition } from 'vue';
...
import useGesture from '../hooks/useGesture.mjs';
    ...
    return function () {
      ...
      return createVNode(Transition, {
        ...
        default: function _default() {
          return [visibleValue.value && createVNode("div", {
            "ref": rootRef,
