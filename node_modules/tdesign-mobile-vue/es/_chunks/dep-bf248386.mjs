...
import { _ as _toConsumableArray } from './dep-fb069758.mjs';
import { _ as _defineProperty } from './dep-f4e31210.mjs';
import { _ as _classCallCheck, a as _createClass } from './dep-fba58676.mjs';
import './dep-9961b95b.mjs';
import './dep-4055ef5c.mjs';
    ...
    value: function _replaceRegexp(searchValue, replacement) {
      ...
      if (searchValue.global) {
        ...
        matches.forEach(function (match) {
          if (match.index != null) {
            var _replacement2 = getReplacement(match, _this2.original);
            if (_replacement2 !== match[0]) {
              _this2.overwrite(match.index, match.index + match[0].length, _replacement2);
            }
          }
        });
      } else {
        ...
        if (match && match.index != null) {
          var _replacement3 = getReplacement(match, this.original);
          if (_replacement3 !== match[0]) {
            this.overwrite(match.index, match.index + match[0].length, _replacement3);
          }
        }
      }
      return this;
...
//# sourceMappingURL=dep-bf248386.mjs.map
