...
import { defineComponent, toRefs, ref, computed, watch, provide, createVNode, resolveComponent } from 'vue';
import { get, isString, isBoolean, isFunction } from 'lodash-es';
...
var getIndexFromColumns = function getIndexFromColumns(column, value, keys) {
  if (!value) return 0;
  return column === null || column === void 0 ? void 0 : column.findIndex(function (item) {
    var _keys$value;
    return get(item, (_keys$value = keys === null || keys === void 0 ? void 0 : keys.value) !== null && _keys$value !== void 0 ? _keys$value : "value") === value;
  });
};
var _Picker = defineComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    var curIndexArray = realColumns.value.map(function (item, index) {
      ...
      return getIndexFromColumns(item, (_pickerValue$value2 = pickerValue.value) === null || _pickerValue$value2 === void 0 ? void 0 : _pickerValue$value2[index], keys.value);
    });
    ...
    var handleConfirm = function handleConfirm(e) {
      ...
      var label = target.map(function (item) {
        var _keys$value$label, _keys$value2;
        return get(item, (_keys$value$label = (_keys$value2 = keys.value) === null || _keys$value2 === void 0 ? void 0 : _keys$value2.label) !== null && _keys$value$label !== void 0 ? _keys$value$label : "label");
      });
      var value2 = target.map(function (item) {
        var _keys$value$value, _keys$value3;
        return get(item, (_keys$value$value = (_keys$value3 = keys.value) === null || _keys$value3 === void 0 ? void 0 : _keys$value3.value) !== null && _keys$value$value !== void 0 ? _keys$value$value : "value");
      });
    ...
    var handlePick = function handlePick(context, column) {
      var _realColumns$value, _keys$value$value2, _keys$value4, _props$onPick;
      var index = context.index;
      curIndexArray[column] = index;
      curValueArray.value[column] = get((_realColumns$value = realColumns.value) === null || _realColumns$value === void 0 ? void 0 : _realColumns$value[column][index], (_keys$value$value2 = (_keys$value4 = keys.value) === null || _keys$value4 === void 0 ? void 0 : _keys$value4.value) !== null && _keys$value$value2 !== void 0 ? _keys$value$value2 : "value");
    ...
    watch([realColumns, curValueArray], function () {
      realColumns.value.forEach(function (col, idx) {
        ...
        var index = col.findIndex(function (item) {
          var _keys$value$value3, _keys$value5;
          return get(item, (_keys$value$value3 = (_keys$value5 = keys.value) === null || _keys$value5 === void 0 ? void 0 : _keys$value5.value) !== null && _keys$value$value3 !== void 0 ? _keys$value$value3 : "value") === curValueArray.value[idx];
        });
    ...
    provide("picker", _objectSpread({}, toRefs(props)));
    return function () {
      ...
      }, [confirmButtonText.value])]), renderTNodeJSX("header"), createVNode("div", {
