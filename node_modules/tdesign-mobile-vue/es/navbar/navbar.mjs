...
var _Navbar = defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    var navClass = computed(function () {
      return [navbarClass.value, _defineProperty(_defineProperty({}, "".concat(navbarClass.value, "--fixed"), props2.fixed), "".concat(classPrefix.value, "-safe-area-top "), props2.safeAreaInsetTop), props2.visible ? "".concat(navbarClass.value, "--visible").concat(animationSuffix.value) : "".concat(navbarClass.value, "--hide").concat(animationSuffix.value)];
    });
