...
import { ref, h, getCurrentInstance, inject, computed, provide } from 'vue';
import { isString, isFunction, cloneDeep } from 'lodash-es';
import { configProviderInjectKey, defaultGlobalConfig, mergeWith } from './context.mjs';
import './type.mjs';
...
export { provideConfig, t, useConfig };
