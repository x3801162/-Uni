...
import { isVNode, createVNode, defineComponent, reactive, computed, ref, toRefs, onMounted, nextTick, watch } from 'vue';
...
var iconDefault = {
  ...
  warning: createVNode(ErrorCircleFilledIcon, null, null),
  error: createVNode(ErrorCircleFilledIcon, null, null)
};
...
//# sourceMappingURL=notice-bar.mjs.map
