...
import { defineComponent, toRefs, inject, computed, h, createVNode, resolveComponent, Fragment } from 'vue';
...
var _Checkbox = defineComponent({
  ...
  setup: function setup(props, context) {
    ...
    var isDisabled = computed(function () {
      if (!props.checkAll && !isChecked.value && checkboxGroup !== null && checkboxGroup !== void 0 && checkboxGroup.maxExceeded.value) {
        return true;
      }
      return disabled.value;
    });
    var finalReadonly = computed(function () {
      return Boolean(props.readonly || (checkboxGroup === null || checkboxGroup === void 0 ? void 0 : checkboxGroup.readonly.value));
    });
    ...
    return function () {
      ...
      var borderless = props.borderless || (checkboxGroup === null || checkboxGroup === void 0 ? void 0 : checkboxGroup.borderless.value);
