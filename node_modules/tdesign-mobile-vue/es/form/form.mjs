...
import { isArray, isEmpty, isFunction, isBoolean } from 'lodash-es';
...
var _Form = defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    var _toRefs = toRefs(props2),
      ...
      requiredMarkPosition = _toRefs.requiredMarkPosition,
      rules = _toRefs.rules,
    ...
    var submit = /*#__PURE__*/function () {
      var _ref6 = _asyncToGenerator(/*#__PURE__*/regenerator.mark(function _callee3(params) {
