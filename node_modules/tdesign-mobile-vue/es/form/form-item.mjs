...
import { defineComponent, toRefs, inject, computed, ref, nextTick, reactive, onMounted, onBeforeUnmount, watch, provide, createVNode } from 'vue';
import { isNil, isNumber, isBoolean, get, set, template, isString, isArray, cloneDeep } from 'lodash-es';
import { ChevronRightIcon } from 'tdesign-icons-vue-next';
import { validate } from './form-model.mjs';
import props from './form-item-props.mjs';
import { FormInjectionKey, ValidateStatus, FormItemInjectionKey } from './const.mjs';
...
var _FormItem = defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    var requiredMarkPosition = computed(function () {
      return form === null || form === void 0 ? void 0 : form.requiredMarkPosition;
    });
    ...
    var labelClasses = computed(function () {
      return [labelClass, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, "".concat(labelClass, "--required"), needRequiredMark.value), "".concat(labelClass, "--required-right"), needRequiredMark.value && requiredMarkPosition.value === "right"), "".concat(labelClass, "--colon"), hasColon.value), "".concat(labelClass, "--top"), hasLabel.value && (labelAlign.value === "top" || !labelWidth.value)), "".concat(labelClass, "--left"), labelAlign.value === "left" && labelWidth.value), "".concat(labelClass, "--right"), labelAlign.value === "right" && labelWidth.value)];
    });
      ...
      var _ref3 = _asyncToGenerator(/*#__PURE__*/regenerator.mark(function _callee() {
        ...
        return regenerator.wrap(function (_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 1:
              if (resetType === "empty") {
                set(form === null || form === void 0 ? void 0 : form.data, props2.name, getEmptyValue());
              } else if (resetType === "initial") {
                set(form === null || form === void 0 ? void 0 : form.data, props2.name, initialValue.value);
              }
              _context.next = 2;
              return nextTick();
            case 2:
              ...
              result.errorList = result.resultList.filter(function (item) {
                ...
                Object.keys(item).forEach(function (key) {
                  if (!item.message && errorMessages.value[key]) {
                    var compiled = template(errorMessages.value[key]);
    ...
    var validateOnly = /*#__PURE__*/function () {
      var _ref7 = _asyncToGenerator(/*#__PURE__*/regenerator.mark(function _callee4(trigger) {
    ...
    var handleBlur = /*#__PURE__*/function () {
      var _ref0 = _asyncToGenerator(/*#__PURE__*/regenerator.mark(function _callee6() {
