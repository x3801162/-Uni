...
import { _ as _objectWithoutProperties } from '../_chunks/dep-a27c5c00.mjs';
  ...
  var component = defineComponent({
    render: function render() {
      return h(Message, _objectSpread(_objectSpread({}, otherOptions), {}, {
        ...
        onCloseBtnClick: function onCloseBtnClick(context2) {
          var _otherOptions$onClose;
          (_otherOptions$onClose = otherOptions.onCloseBtnClick) === null || _otherOptions$onClose === void 0 || _otherOptions$onClose.call(otherOptions, context2);
          visible.value = false;
        },
