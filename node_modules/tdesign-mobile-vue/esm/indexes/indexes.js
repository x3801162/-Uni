...
import { defineComponent, toRefs, ref, reactive, computed, watchEffect, watch, nextTick, onMounted, onBeforeUnmount, provide, createVNode } from 'vue';
...
var _Indexes = defineComponent({
  ...
  setup: function setup(props) {
    ...
    var _useVModel = useVModel(current, modelValue, props.defaultCurrent, function () {}, "current"),
      _useVModel2 = _slicedToArray(_useVModel, 2),
      currentIndex = _useVModel2[0],
      setCurrentIndex = _useVModel2[1];
    var timeOut;
    var indexesRoot = ref();
    var parentRect = ref();
    var state = reactive({
