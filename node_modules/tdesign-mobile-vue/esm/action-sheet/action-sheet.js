...
import { isVNode, defineComponent, computed, toRefs, createVNode, mergeProps } from 'vue';
import TActionSheetGrid from './action-sheet-grid.js';
import TActionSheetList from './action-sheet-list.js';
...
var ActionSheetVue = defineComponent({
  ...
  setup: function setup(props2, context) {
    ...
    var _useVModel = useVModel(visible, modelValue, props2.defaultVisible, function () {}, "visible"),
      _useVModel2 = _slicedToArray(_useVModel, 1),
    ...
    return function () {
      ...
      var root = function root() {
        ...
        var list = function list() {
          if (props2.theme === "list") {
            return createVNode(TActionSheetList, {
              "align": props2.align,
        ...
        var grid = function grid() {
          if (props2.theme === "grid") {
            return createVNode(TActionSheetGrid, {
              "items": actionItems.value,
              "count": props2.count,
              "onSelected": handleSelected
            }, null);
      ...
      return createVNode(Popup, mergeProps(props2.popupProps, {
