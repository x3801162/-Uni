...
var _Upload = defineComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    var renderAddContent = function renderAddContent() {
      ...
      if (props.max === 0 || props.max > 0 && ((_displayFiles$value = displayFiles.value) === null || _displayFiles$value === void 0 ? void 0 : _displayFiles$value.length) < props.max) {
        var addBtnNode = renderTNodeJSX("addBtn", createVNode(AddIcon, null, null));
        var addContentNode = renderTNodeJSX("addContent");
        return createVNode("div", {
    ...
    return function () {
      return createVNode("div", {
        ...
        }), null), renderStatus(file), (isBoolean(file.removeBtn) ? file.removeBtn : props.removeBtn) && createVNode(CloseIcon, {
      ...
      }), renderAddContent(), createVNode("input", {
        "ref": inputRef,
        "value": props.files,
        "type": "file",
