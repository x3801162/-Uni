...
import { defineComponent, toRefs, ref, computed, provide, createVNode } from 'vue';
import TabBarProps from './props.js';
import config from '../config.js';
import useChildSlots from '../hooks/useChildSlots.js';
...
var _TabBar = defineComponent({
  ...
  setup: function setup(props, context) {
    ...
    var updateItemCount = function updateItemCount(vNodes) {
      if (!vNodes || !Array.isArray(vNodes)) {
        itemCount.value = 0;
        return;
      }
      var childSlots = useChildSlots("".concat(prefix, "-tab-bar-item"), vNodes);
