...
import { defineComponent, inject, computed, ref, toRefs, nextTick, onMounted, watch, createVNode } from 'vue';
...
var _Textarea = defineComponent({
  ...
  setup: function setup(props2, context) {
    ...
    var textareaInnerClasses = computed(function () {
      return ["".concat(textareaClass.value, "__wrapper-inner"), "".concat(textareaClass.value, "__placeholder"), _defineProperty(_defineProperty({}, "".concat(textareaClass.value, "--disabled"), isDisabled.value), "".concat(textareaClass.value, "--readonly"), props2.readonly)];
    });
    var textareaRef = ref();
    ...
    return function () {
      ...
      var textareaAttrs = {
        ...
        style: _objectSpread(_objectSpread({}, textareaStyle.value), {}, {
