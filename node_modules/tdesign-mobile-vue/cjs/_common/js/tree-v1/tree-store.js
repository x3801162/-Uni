...
var mitt = require('../../../_chunks/dep-2c3f586f.js');
...
var _initCloneObject = require('../../../_chunks/dep-2457b474.js');
var isArray = require('../../../_chunks/dep-3cf5587c.js');
var camelCase = require('../../../_chunks/dep-a65592ed.js');
...
require('../../../_chunks/dep-950a1d46.js');
  ...
  return _createClass__default["default"](TreeStore, [{
    ...
    value: function getNodes(item, options) {
      ...
      if (options) {
        ...
        if (_initCloneObject.isPlainObject(conf.props)) {
          nodes = nodes.filter(function (node) {
