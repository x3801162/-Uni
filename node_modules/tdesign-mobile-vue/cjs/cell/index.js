...
var cell_cell = require('./cell.js');
var cell_cellGroup = require('./cell-group.js');
...
require('./cell-group-props.js');

var Cell = shared_component.withInstall(cell_cell["default"]);
var CellGroup = shared_component.withInstall(cell_cellGroup["default"]);
