...
var Vue = require('vue');
var actionSheet_actionSheet = require('./action-sheet.js');
var shared_util = require('../shared/util.js');
require('@babel/runtime/helpers/slicedToArray');
require('./action-sheet-grid.js');
...
function create(props) {
  ...
  instance = actionSheet_actionSheet["default"];
...
ActionSheet.install = function (app2) {
  ...
  app2.component(name || actionSheet_actionSheet["default"].name, actionSheet_actionSheet["default"]);
};
var _ActionSheet = ActionSheet;

exports._ActionSheet = _ActionSheet;
exports["default"] = _ActionSheet;
