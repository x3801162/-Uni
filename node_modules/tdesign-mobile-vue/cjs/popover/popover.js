...
var Vue = require('vue');
var popover_props = require('./props.js');
...
var _Popover = Vue.defineComponent({
  ...
  props: popover_props["default"],
  emits: ["visible-change", "update:visible", "update:modelValue"],
  setup: function setup(props, context) {
    var popoverClass = hooks_useClass.usePrefixClass("popover");
    var renderTNodeJSX = hooks_tnode.useTNodeJSX();
    var renderContent = hooks_tnode.useContent();
    var _toRefs = Vue.toRefs(props),
      visible = _toRefs.visible,
      modelValue = _toRefs.modelValue;
    var _useVModel = hooks_useVModel["default"](visible, modelValue, props.defaultVisible, props.onVisibleChange, "visible"),
    ...
    var placementPadding = function placementPadding(_ref) {
      ...
      if (isHorizontal) {
        ...
        return _defineProperty__default["default"]({}, isEnd ? "left" : "right", padding - 28);
      }
      var isVertical = vertical.find(function (item) {
        return placement.includes(item);
      });
      if (isVertical) {
        return _defineProperty__default["default"]({}, isEnd ? "top" : "bottom", popperHeight - 28);
      }
    };
    ...
    var closeOnClickOutside = Vue.ref(shared_useClickAway_index.useClickAway([referenceRef, popoverRef], function () {
      onClickAway();
    }, {
      detectIframe: true
    }));
