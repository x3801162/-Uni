...
import { defineComponent, ref, toRefs, inject, computed, watch, nextTick, createVNode } from 'vue';
...
var _Input = defineComponent({
  ...
  setup: function setup(props, context) {
    ...
    var inputClasses = computed(function () {
      return ["".concat(inputClass.value, "__control"), _defineProperty(_defineProperty(_defineProperty(_defineProperty({}, "".concat(inputClass.value, "--").concat(props.align), props.align !== "left"), "".concat(inputClass.value, "--").concat(status), status), "".concat(inputClass.value, "__control--disabled"), isDisabled.value), "".concat(inputClass.value, "--password"), renderType.value === "password")];
    });
    ...
    var inputValueChangeHandle = function inputValueChangeHandle(e) {
      ...
      setInnerValue(getValueByLimitNumber(value2));
      nextTick(function () {
    ...
    return function () {
      ...
      var inputAttrs = {
        ...
        style: {
          "--td-input-cursor-color": props.cursorColor
        },
        onFocus: handleFocus,
        onBlur: handleBlur,
        onInput: handleInput,
      ...
      }, [createVNode("input", inputAttrs, null), renderClearable(), renderSuffix(), renderSuffixIcon()]), renderTips()]), renderExtra()]);
    };
  }
});
