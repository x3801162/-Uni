...
import { defineComponent, computed, ref, toRefs, onMounted, onBeforeUnmount, onActivated, watch, nextTick, provide, readonly, createVNode, mergeProps, Fragment, h } from 'vue';
  ...
  setup: function setup(props2) {
    ...
    var moveToActiveTab = function moveToActiveTab() {
      if (navWrap.value && navLine.value && props2.showBottomLine) {
        ...
        var isInit = previousValue.value === void 0;
        previousValue.value = currentValue.value;
        if (isInit) {
          style.transitionDuration = "0s";
        } else if (props2.animation) {
    ...
    watch(currentValue, function () {
      nextTick(function () {
        moveToActiveTab();
      });
    });
    watch(itemProps, function () {
      nextTick(function () {
        moveToActiveTab();
      });
    }, {
    ...
    return function () {
      return createVNode("div", {
        ...
        default: function _default() {
          return [createVNode("div", {
            ...
            "ref": navScroll,
            "class": ["".concat(tabsClass.value, "__scroll"), "".concat(tabsClass.value, "__scroll--").concat(props2.theme), _defineProperty({}, "".concat(tabsClass.value, "__scroll--split"), props2.split)]
          }, [createVNode("div", {
            "ref": navWrap,
      ...
      }), renderTNodeJSX("middle"), createVNode("div", {
