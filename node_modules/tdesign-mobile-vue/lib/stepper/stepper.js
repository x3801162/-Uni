...
var _Stepper = defineComponent({
  ...
  setup: function setup(props2, context) {
    ...
    var _useVModel = useVModel(value, modelValue, props2.defaultValue, props2.onChange),
      ...
      stepperValue = _useVModel2[0],
      setStepperValue = _useVModel2[1];
    ...
    var formatValue = function formatValue(value2) {
      return Math.max(Math.min(max.value, value2, Number.MAX_SAFE_INTEGER), min.value, Number.MIN_SAFE_INTEGER).toFixed(Math.max(getLen(step.value), getLen(value2)));
    };
    var updateValue = function updateValue(value2) {
      setStepperValue(formatNumber("".concat(value2), !integer.value));
    };
    ...
    var handleInput = function handleInput(e) {
      var value2 = formatNumber(e.target.value, !integer.value);
      setStepperValue(value2);
    };
