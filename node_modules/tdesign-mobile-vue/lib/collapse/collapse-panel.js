  ...
  setup: function setup(props2, _ref) {
    ...
    return function () {
      ...
      return createVNode("div", {
        ...
        "class": ["".concat(collapsePanelClass.value, "__title"), "".concat(collapsePanelClass.value, "__header"), "".concat(collapsePanelClass.value, "__header--").concat(props2.placement), _defineProperty({}, "".concat(collapsePanelClass.value, "__header--expanded"), isActive.value)],
        "onClick": handleClick
      }, {
        ...
        "class": "".concat(collapsePanelClass.value, "__body"),
        "style": {
          gridTemplateRows: isActive.value ? "1fr" : "0fr"
        }
      }, [createVNode("div", {
        "class": "".concat(collapsePanelClass.value, "__inner")
      }, [renderPanelContent()])])]);
    };
  }
});
