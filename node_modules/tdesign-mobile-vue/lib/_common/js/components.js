...
var NON_PASCAL_CASE_NAMES = {
  qrcode: "QRCode"
};
var WEB_COMPONENT_MAP = {
  affix: ["Affix"],
  alert: ["Alert"],
...
var CHAT_COMPONENT_MAP = {
  attachments: ["Attachments"],
  "chat-actionbar": ["ChatActionbar", "ChatAction"],
  "chat-content": ["ChatContent"],
  "chat-input": ["ChatInput"],
  "chat-item": ["ChatItem"],
  "chat-list": ["ChatList", "Chat"],
...
export { CHAT_COMPONENT_MAP, MOBILE_COMPONENT_MAP, NON_PASCAL_CASE_NAMES, WEB_COMPONENT_MAP };
