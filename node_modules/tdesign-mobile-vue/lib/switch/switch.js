...
var _Switch = defineComponent({
  ...
  setup: function setup(props2, context) {
    ...
    var dotClasses = computed(function () {
      ...
      return ["".concat(switchClass.value, "__dot"), "".concat(switchClass.value, "__dot--").concat(props2.size), _defineProperty(_defineProperty(_defineProperty({}, "".concat(switchClass.value, "__dot--checked"), checked.value), "".concat(switchClass.value, "__dot--plain"), ((_props2$label = props2.label) === null || _props2$label === void 0 ? void 0 : _props2$label.length) !== 2 && ((_props2$icon = props2.icon) === null || _props2$icon === void 0 ? void 0 : _props2$icon.length) !== 2 && !props2.loading), "".concat(switchClass.value, "__dot--disabled"), disabled.value || props2.loading)];
    });
    ...
    var renderContent = function renderContent() {
      if (props2.loading) {
        return createVNode(Loading, {
          "class": "".concat(switchClass.value, "__loading"),
          "size": "16px"
        }, null);
      }
