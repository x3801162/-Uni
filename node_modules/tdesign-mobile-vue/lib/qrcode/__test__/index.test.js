...
import { ssrUtils, initDirectivesForSSR, nextTick, defineComponent, computed, h, shallowReactive, reactive, isRef, ref, createApp, transformVNodeArgs, setDevtoolsHook, Transition, BaseTransition, TransitionGroup } from 'vue';
...
import { v as vi } from '../../_chunks/dep-f93ad091.js';
import '../qrcode.js';
import 'lodash-es';
import '../props.js';
...
var isReservedProp = /* @__PURE__ */makeMap$2(
// the leading comma is intentional so empty string "" is also included
",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted");
var isBuiltInDirective = /* @__PURE__ */makeMap$2("bind,cloak,else-if,else,for,html,if,model,on,once,pre,show,slot,text,memo");
...
var toHandlerKey = cacheStringFunction$2(function (str) {
  var s = str ? "on".concat(capitalize$2(str)) : "";
  return s;
});
var PatchFlagNames = (_PatchFlagNames$2 = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_PatchFlagNames$2, 1, "TEXT"), 2, "CLASS"), 4, "STYLE"), 8, "PROPS"), 16, "FULL_PROPS"), 32, "NEED_HYDRATION"), 64, "STABLE_FRAGMENT"), 128, "KEYED_FRAGMENT"), 256, "UNKEYED_FRAGMENT"), 512, "NEED_PATCH"), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_PatchFlagNames$2, 1024, "DYNAMIC_SLOTS"), 2048, "DEV_ROOT_FRAGMENT"), -1, "CACHED"), -2, "BAIL"));
...
var stack = [];
var tokenizer$3 = new Tokenizer(stack, {
  onerr: emitError,
...
function onCloseTag(el, end) {
  ...
  if (tokenizer$3.inXML && (stack[0] ? stack[0].ns : currentOptions.ns) === 0) {
...
function walk(node, parent, context) {
    ...
    if (child.type === 1 && child.tagType === 0) {
      ...
      if (_constantType >= 2) {
        if (child.codegenNode.type === 14 && child.codegenNode.arguments.length > 0) {
          child.codegenNode.arguments.push(-1 + (!!(process.env.NODE_ENV !== "production") ? " /* ".concat(PatchFlagNames[-1], " */") : ""));
        }
        toCache.push(child);
        continue;
      }
  ...
  if (!cachedAsArray) {
    var _iterator11 = _createForOfIteratorHelper$2(toCache),
      _step11;
    try {
    ...
    if (p.type === 6) {
      ...
      if (p.name === "bind" && isStaticArgOf(p.arg, "name")) {
        if (p.exp) {
          ...
          var name = camelize$1(p.arg.content);
...
var transformModel$1 = function transformModel(dir, node, context) {
  ...
  var eventName = arg ? isStaticExp(arg) ? "onUpdate:".concat(camelize$1(arg.content)) : createCompoundExpression(['"onUpdate:" + ', arg]) : "onUpdate:modelValue";
  var assignmentExp;
...
var transformVBindShorthand = function transformVBindShorthand(node, context) {
  if (node.type === 1) {
    var _iterator12 = _createForOfIteratorHelper$2(node.props),
      _step12;
    try {
      for (_iterator12.s(); !(_step12 = _iterator12.n()).done;) {
        ...
        prop.exp.type === 4 && !prop.exp.content.trim()) && prop.arg) {
          ...
          if (arg.type !== 4 || !arg.isStatic) {
            ...
            var propName = camelize$1(arg.content);
...
function getBaseTransformPreset(prefixIdentifiers) {
  return [[transformVBindShorthand, transformOnce, transformIf, transformMemo, transformFor].concat([transformFilter], _toConsumableArray(!!(process.env.NODE_ENV !== "production") ? [transformExpression] : []), [transformSlotOutlet, transformElement, trackSlotScopes, transformText]), {
    on: transformOn$1,
    bind: transformBind,
...
function baseCompile(source) {
  ...
  var resolvedOptions = extend$1({}, options, {
    prefixIdentifiers: prefixIdentifiers
  });
  ...
  transform(ast, extend$1({}, resolvedOptions, {
...
function makeMap$1(str) {
  var map = /* @__PURE__ */Object.create(null);
  var _iterator = _createForOfIteratorHelper$1(str.split(",")),
    _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var key = _step.value;
...
(_PatchFlagNames$1 = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_PatchFlagNames$1, 1, "TEXT"), 2, "CLASS"), 4, "STYLE"), 8, "PROPS"), 16, "FULL_PROPS"), 32, "NEED_HYDRATION"), 64, "STABLE_FRAGMENT"), 128, "KEYED_FRAGMENT"), 256, "UNKEYED_FRAGMENT"), 512, "NEED_PATCH"), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_PatchFlagNames$1, 1024, "DYNAMIC_SLOTS"), 2048, "DEV_ROOT_FRAGMENT"), -1, "CACHED"), -2, "BAIL"));
...
var isSVGTag = /* @__PURE__ */makeMap$1(SVG_TAGS);
var isMathMLTag = /* @__PURE__ */makeMap$1(MATH_TAGS);
var isVoidTag = /* @__PURE__ */makeMap$1(VOID_TAGS);
...
var transformOn = function transformOn(dir, node, context) {
  return transformOn$1(dir, node, context, function (baseResult) {
    ...
    if (eventOptionModifiers.length) {
      var modifierPostfix = eventOptionModifiers.map(capitalize$1).join("");
...
(_PatchFlagNames = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_PatchFlagNames, 1, "TEXT"), 2, "CLASS"), 4, "STYLE"), 8, "PROPS"), 16, "FULL_PROPS"), 32, "HYDRATE_EVENTS"), 64, "STABLE_FRAGMENT"), 128, "KEYED_FRAGMENT"), 256, "UNKEYED_FRAGMENT"), 512, "NEED_PATCH"), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_PatchFlagNames, 1024, "DYNAMIC_SLOTS"), 2048, "DEV_ROOT_FRAGMENT"), -1, "HOISTED"), -2, "BAIL"));
_defineProperty(_defineProperty(_defineProperty({}, 1, "STABLE"), 2, "DYNAMIC"), 3, "FORWARDED");
...
ssrUtils.createComponentInstance;
  ssrUtils.setCurrentRenderingInstance;
  ssrUtils.setupComponent;
  ssrUtils.renderComponentRoot;
  ssrUtils.normalizeVNode;
ssrUtils.isVNode;
ssrUtils.isVNode;
